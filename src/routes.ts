...
export default (router: Router) => {
  ...
  router.get("/products", (req, res) => controllers.ProductController.getPaginated(req, res));
  router.get("/products/all", (req, res) => controllers.ProductController.getAll(req, res));
